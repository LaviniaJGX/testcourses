...
4. Commit ‘work units’; 
   $F:\Agile Software Practice\coursestest>git rebase -i 927c74e067d899
...
5. Rollback;
   ...
   Also , I commit "test rollback" ,then: 
     $ git revert 70a3692d38ebaa0f2 , we can get that: 
